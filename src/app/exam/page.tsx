  ...
  return (
    <main className="pt-20">
      ...
      <SectionWrapper>
        <motion.div {...fadeIn} className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-tapex-muted">
            ...
            <span className="text-tapex-text font-semibold">
      ...
      <SectionWrapper className="bg-tapex-primary/50">
        <h2 className="font-display mb-8 text-2xl font-bold sm:text-3xl">시험 개요</h2>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {[
            ...
            <motion.div
              ...
              className={`rounded-2xl border bg-tapex-card p-6 ${l.color}`}
            >
              ...
              <p className="text-sm font-semibold text-tapex-accent">{l.subtitle}</p>
      ...
      {/* Question Types */}
      <SectionWrapper className="bg-tapex-primary/50">
        <h2 className="font-display mb-8 text-2xl font-bold sm:text-3xl">문항 유형</h2>
        <div className="overflow-x-auto">
          <table className="w-full min-w-[600px] text-sm">
            <thead>
              <tr className="border-b border-tapex-border text-left">
                <th className="p-4 text-tapex-muted">유형</th>
                <th className="p-4 text-tapex-muted">비율</th>
                <th className="p-4 text-tapex-muted">문항 수</th>
                <th className="p-4 text-tapex-muted">무엇을 측정하나요?</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-tapex-border/50">
              {[
                ...
                <tr key={i}>
                  ...
                  <td className="p-4 text-tapex-text">{ratio}</td>
                  <td className="p-4 text-tapex-text">{count}</td>
                  <td className="p-4 text-tapex-muted">{desc}</td>
                </tr>
              ))}
            </tbody>
          </table>
        </div>
        <p className="mt-6 rounded-xl border border-tapex-accent/30 bg-tapex-accent/5 p-4 text-sm text-tapex-accent">
      ...
      {/* Scoring Pipeline */}
      <SectionWrapper>
        <h2 className="font-display mb-4 text-2xl font-bold sm:text-3xl">채점 방식</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <motion.div
              ...
              {...fadeIn}
              transition={{ delay: i * 0.1 }}
              className="relative rounded-2xl border border-tapex-border bg-tapex-card p-6"
            >
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-tapex-border text-left">
                <th className="p-4 text-tapex-muted">기준</th>
                <th className="p-4 text-tapex-muted">비중</th>
                <th className="p-4 text-tapex-muted">의미</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-tapex-border/50">
              {[
                ...
                <tr key={i}>
                  <td className="p-4 font-semibold text-tapex-accent">{criterion}</td>
                  <td className="p-4 text-tapex-text">{weight}</td>
                  <td className="p-4 text-tapex-muted">{meaning}</td>
                </tr>
              ))}
            </tbody>
          </table>
