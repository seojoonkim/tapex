  ...
  return (
    <>
      <nav style={{
        ...
        <span style={{ fontFamily: FONT, fontWeight: 700, fontSize: 24, letterSpacing: '-0.02em', color: '#0F172A', display: 'flex', alignItems: 'center', gap: 0, position: 'relative' }}>
          TAPEX
      ...
      <div ref={sectionFade.ref} style={{ ...sectionFade.style, maxWidth: 1200, margin: '0 auto', display: 'flex', flexDirection: isMobile ? 'column-reverse' : 'row', flexWrap: 'wrap', gap: isMobile ? 48 : 80, alignItems: 'center' }}>
        ...
        <div style={{ flex: '1 1 440px' }}>
          ...
          <p style={{ fontSize: isMobile ? 15 : 17, color: '#475569', lineHeight: 1.8, marginBottom: 20 }}>
            OpenAI 리포트에 따르면, AI 파워유저는 같은 회사 동료 대비 <strong style={{ color: '#0F172A', fontSize: '110%' }}>6배</strong> 높은 생산성을 보입니다. PwC 조사에서 AI 스킬 보유자는 동일 직무 대비 연봉이 <strong style={{ color: '#0F172A', fontSize: '110%' }}>56%</strong> 더 높습니다.
          </p>
          <p style={{ fontSize: isMobile ? 15 : 17, color: '#475569', lineHeight: 1.8, marginBottom: 20 }}>
  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: isMobile ? 20 : 72, flexWrap: 'nowrap' }}>
          <img src="/logos/hankook.jpg" alt="한국경제신문" style={{ height: isMobile ? 20 : 28, width: 'auto', maxWidth: isMobile ? 90 : 160, objectFit: 'contain', opacity: 0.65 }} />
          <img src="/logos/hashed.jpg" alt="HASHED" style={{ height: isMobile ? 20 : 28, width: 'auto', maxWidth: isMobile ? 90 : 160, objectFit: 'contain', opacity: 0.65 }} />
          <img src="/logos/bloomingbit.jpg" alt="bloomingbit" style={{ height: isMobile ? 20 : 28, width: 'auto', maxWidth: isMobile ? 90 : 160, objectFit: 'contain', opacity: 0.65 }} />
        </div>
      </div>
    </section>
  );
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 32, flexWrap: 'wrap', marginBottom: 48 }}>
          {badges.map((b, i) => (
            ...
            >
              ...
              <div style={{ fontWeight: 800, fontSize: 18, color: '#0F172A', marginBottom: 4, letterSpacing: '-0.03em', fontFamily: FONT }}>
                TAPEX {b.level}
              </div>
